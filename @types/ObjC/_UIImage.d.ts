import { CGFloat, CGSize, CGPoint, CGRect, CGBlendMode, UIEdgeInsets } from "./UIKit";
...
export declare class UIImage {
   ...
   * @returns UIImage*
   */
  static imageWithCGImage(cgImage: WrapperObj<any>, scale: CGFloat, orientation: UIImageOrientation): UIImage; 
   ...
   */
  stretchableImageWithLeftCapWidth(leftCapWidth: number, topCapHeight: number): UIImage; 
  /**
   * @returns NSData*
